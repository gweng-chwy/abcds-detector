...
def test_full_video_frame_timestamps_use_max_frames_not_sample_rate(tmp_path):
  """Full-video evidence uses the configured max frame count."""
  preprocessor = VideoPreprocessor(
      cache_dir=str(tmp_path / "cache"),
      max_frames=2,
  ...
  assert preprocessor._full_video_timestamps(5.0) == [0.0, 5.0]
